...
public class MLGaussianSlotProfilingNode extends AbstractNode {
    ...
    public static class Factory implements NodeFactory {
        ...
        public Node create(long world, long time, long id, Graph graph, long[] initialResolution) {
            return new MLGaussianSlotProfilingNode(world, time, id, graph, initialResolution);
        }
    }
    ...
    public void setProperty(String propertyName, byte propertyType, Object propertyValue) {
        ...
        if(propertyName.equals(PERIOD_SIZE)){
    ...
    public Object get(String attributeName) {
        ...
        if (attributeName.equals(PERIOD_SIZE)) {
    ...
    public MLGaussianSlotProfilingNode(long p_world, long p_time, long p_id, Graph p_graph, long[] currentResolution) {
