package org.mwg.maths.matrix.jamasolver;


import org.mwg.maths.matrix.KMatrix;
import org.mwg.maths.matrix.KSVDDecompose;
 ...
 * ------------------------ */
   ...
   */
   ...
   public SVD(KMatrix Arg) {

      // Derived from LINPACK code.
      // Initialize.
      double[][] A = Utils.convertToArray(Arg);
      m = Arg.rows();
      n = Arg.columns();
 ...
 * ------------------------ */
   ...
   */
   ...
   @Override
   public KMatrix getU () {
      return Utils.convertToMatrixArg(U,m,Math.min(m+1,n));
   }

   @Override
   public KMatrix getVt() {
      return KMatrix.transpose(getV());
   }
   ...
   */
   ...
   public KMatrix getV () {
      return Utils.convertToMatrixArg(V,n,n);
   }
