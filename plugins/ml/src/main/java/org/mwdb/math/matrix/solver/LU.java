...
public class LU {
    ...
    public LU(int m, int n, KBlas blas) {
        this._blas=blas;
        LU = new Matrix(null, m, n,blas.matrixType());
    ...
    public KMatrix getLower()
    {
        ...
        Matrix lower = new Matrix(null, numRows,numCols,_blas.matrixType());
    ...
    public KMatrix getUpper()
    {
        ...
        KMatrix upper = new Matrix(null,numRows, numCols,_blas.matrixType());
